...
{VEIL}
  ...
  <section class="row visit">
    ...
    <div class="inB sec-note">
      ...
      мають власний підпис — назву чи опис від автора або джерела; решта підписана
      за розділом і роком зйомки, коли точнішого опису немає. Для архівного фото
      це звичайна ситуація, а не прогалина: не кожен кадр приходить із власною
      історією.</p>
